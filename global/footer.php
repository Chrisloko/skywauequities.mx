  <div id="footer-wrap" class="is-clearfix" style="border-top: 1px solid #192b41; background-color: #192b41; padding: 60px 0 60px">
            ...
            <div class="row">
              <div class="col-md-9" style="display: flex; flex-wrap: wrap">
				    ...
				    <div class="menu-footer" style="display: inline-block">
				  		<ul>
							<li><a href="#header-image">¿Quiénes Somos?</a></li>
							<li><a href="#distribucion">Nuestra Presencia</a></li>
							<li><a href="/index.php#proyectos">Proyectos  </a></li>
							<li><a href="/index.php#contacto">Contacto</a></li>
              <li><a href="/index.php#contacto">Bolsa de trabajo</a></li>
						</ul>
				    </div>
                </div>
              
              <div class="col-md-3 right-footer" style="display: flex; flex-direction: column">
                	<ul class="social">
                      <!-- <li>
                    ...
                    <p>SkyWay Equities ® 2021. Todos los derechos reservados.<br> Aviso de Privacidad</p>  
...
//	});
	...
	function scrollFunction() {
	  if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80 && window.innerWidth > 901) {
		document.getElementById("header-wrap").style.background = "rgba(0,0,0,1)";
    // document.getElementById("header-wrap").classList.remove('pad-top-nav');
	  } else {
		document.getElementById("header-wrap").style.background = "rgba(0,0,0,.5)";
...
<!--  Counter	-->
    ...
    decimalsno: 0,           // the number of decimal places to show
...
jQuery(function ($) {
  ...
  $('.count-number-nod').data('countToOptions', {
	formatter: function (value, options) {
	  return value.toFixed(options.decimalsno).replace(/\B(?=(?:\d{3})+(?!\d))/g, ',');
	}
  });
